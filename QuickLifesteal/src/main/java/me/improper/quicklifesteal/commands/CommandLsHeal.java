 ...
 * Command executor
 */
public class CommandLsHeal implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        try {
            ...
            p.setFoodLevel(20);
            p.setSaturation(20);
            p.setSaturatedRegenRate(100);
            sender.sendMessage("\n" + QuickLifesteal.starter + "§bYou've healed §7" + p.getName() + "\n ");
            sender.sendMessage("\n" + QuickLifesteal.starter + "§bYou've been healed by §7" + sender.getName() + "\n ");
        } catch (Exception ex) {
